    ...
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" 
                ...
                @if(auth()->user()->hasCompletedProfile() && auth()->user()->verification_status === 'approved')
                <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-slate-600 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
